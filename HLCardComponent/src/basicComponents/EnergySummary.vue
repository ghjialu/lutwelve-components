...
<style scoped>
  ...
  .card_in .container-list .list-item {
    padding: 0 12px 0 0;
  ...
  .card_in .container-list .list-item .item {
    width: 100%;
    overflow: hidden;
    flex: 1;
    display: flex;
  ...
  .card_in .container-list .list-item .item:first-child::after {
    content: '';
  ...
  .card_in .container-list .list-item .item .conten-box {
    flex: 1;
    display: flex;
    flex-direction: column;
  ...
  .card_in .container-list .list-item .item .name {
    width: 100%;
    display: flex;
    padding-left: 24px;
  ...
  .card_in .container-list .list-item .item .name .icon {
    width: 24px;
    height: 24px;
  }

  .card_in .container-list .list-item .item .name .icon img {
    width: 100%;
  }

  .card_in .container-list .list-item .item .name .text {
    font-size: 14px;
    color: #333;
    line-height: 24px;
    white-space: nowrap;
    ...
    text-overflow: ellipsis;
          ...
          .card_in .container-list .list-item .item .value {
            font-size: 1rem;
            font-weight: 600;
            color: #333333;
            display: flex;
          ...
          .card_in .container-list .list-item .item .value .number-value {
          ...
          .card_in .container-list .list-item .item .value .unitLevel {
            display: inline-block;
            margin-left: 4px;
            font-size: 14px;
            font-weight: 400;
          ...
          .card_in .container-list .list-item .item .value .unit {
            display: inline-block;
            margin-left: 4px;
            font-size: 14px;
            font-weight: 400;
          ...
          .card_in .container-list .list-item .item .value .ups-icon {
            display: inline-block;
            margin-left: 6px;
          }

          .card_in .container-list .list-item .item .value-before {
            margin: 0 0 0 0;
          }

          .card_in .container-list .list-item .item:nth-child(1) .conten-box {
            padding-left: 24px;
            padding-right: 24px;
          }

          .card_in .container-list .list-item .item:nth-child(1) .name {
            padding-left: 0;
          }

          .card_in .container-list .list-item .item:nth-child(1) .value {
            padding-left: 0;
          }

          .card_in .container-list .list-item .item:nth-child(2) .name .text,
  .card_in .container-list .list-item .item:nth-child(3) .name .text {
    /* padding-left: 4px; */
  }

          .card_in .container-list .list-item .item:nth-child(2) .value,
  .card_in .container-list .list-item .item:nth-child(3) .value {
    padding-left: 24px;
    /* padding-left: 41px; */
  }
